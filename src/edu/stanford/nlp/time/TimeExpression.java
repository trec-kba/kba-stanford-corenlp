...
public class TimeExpression {
  ...
  public CoreMap extractAnnotation(CoreMap sourceAnnotation)
  {
    if (chunkOffsets != null) {
      ...
      if (annotation == null || annotation.get(CoreAnnotations.CharacterOffsetBeginAnnotation.class) == null) return null;
      ...
      if (baseCharOffset == null) { baseCharOffset = 0; };
