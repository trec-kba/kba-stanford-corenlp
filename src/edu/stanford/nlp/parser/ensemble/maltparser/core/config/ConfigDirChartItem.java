...
public class ConfigDirChartItem extends ChartItem {
	...
	public void initialize(FlowChartInstance flowChartinstance, ChartItemSpecification chartItemSpecification) throws MaltChainedException {
		...
		configDir = (ConfigurationDir)flowChartinstance.getFlowChartRegistry(edu.stanford.nlp.parser.ensemble.maltparser.core.config.ConfigurationDir.class, idName);
		if (configDir == null) {
			...
			flowChartinstance.addFlowChartRegistry(edu.stanford.nlp.parser.ensemble.maltparser.core.config.ConfigurationDir.class, idName, configDir);
		}
