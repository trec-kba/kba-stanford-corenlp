package edu.stanford.nlp.parser.ensemble.maltparser.core.feature.spec;
...
import edu.stanford.nlp.parser.ensemble.maltparser.core.feature.spec.reader.FeatureSpecReader;
import edu.stanford.nlp.parser.ensemble.maltparser.core.feature.spec.reader.ParReader;
...
//		setConfiguration(configuration);
	...
	public void loadParReader(URL specModelURL, boolean malt04, String markingStrategy, String coveredRoot) throws MaltChainedException {
		...
		try {
			Class<?> clazz = Class.forName(Constants.BASE_MALT_CLASSPATH + ".core.feature.spec.reader."+urlSuffix+"Reader");
